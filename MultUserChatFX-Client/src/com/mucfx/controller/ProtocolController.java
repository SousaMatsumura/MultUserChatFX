...
public class ProtocolController {
   ...
   void buttonApplyAction(ActionEvent event) {
      try{
         if(textFieldLogin.getText() == null) {
            ...
            System.out.println("Command Splitter"+ StringUtils.remove(String.valueOf(textFieldCommandSplitter.getText()), "\"").charAt(0));
            System.out.println("User Splitter"+ StringUtils.remove(String.valueOf(textFieldUserSplitter.getText()), "\"").charAt(0));
   ...
   * que são assim validados.*/
   ...
   public ArrayList<String> MultiIntersection(ArrayList<String>... args){
      System.out.println(Main.getDefaultProtocol());
   ...
   void buttonCancelAction(ActionEvent event) {
      changeScreen(Main.getPrevState(), client);
   }
   ...
   void buttonDefaultAction(ActionEvent event) {
      ...
      textFieldServerToClientMessage.setText(Main.getDefaultProtocol().getProtocolServerToClientMessage());
      ...
      textFieldClientToServerMessage.setText(Main.getDefaultProtocol().getProtocolClientToServerMessage());
   ...
   private void onChangeListener() {
      Main.addOnChangeScreenListener(new Main.OnChangeScreen() {
         ...
         public void onScreenChanged(String newScreen, Object userData) {
            System.out.println("newScreen: "+newScreen+" | "+userData);
            if(newScreen.equals("protocol")){
               next = String.valueOf(userData);
               if(userData != null){
   ...
   protected void initialize(){
      ...
      textFieldServerToClientMessage.setText(Main.getCurrentProtocol().getProtocolServerToClientMessage());
      ...
      textFieldClientToServerMessage.setText(Main.getCurrentProtocol().getProtocolClientToServerMessage());
